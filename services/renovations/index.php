                        ...
                        <div class="service-details__left">
                            <div class="service-details__category">
                                <ul class="service-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a
                                            href="<?php echo HTTP_PATH ?>services/renovations/">Renovations<span
                        ...
                        <div class="service-details__right">
                            <div class="service-details__content-box">
                                <div class="service-details__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/services/renovations.webp"
                                        alt="">
                                </div>
                                <h3 class="service-details__title">Renovations</h3>
                                <p class="service-details__text-1">Swarna Constructions specializes in transforming
                                    residential and commercial spaces through expertly managed renovation services.
                                    Whether it’s modernizing outdated structures, adding new rooms, or upgrading
                                    interiors, the company ensures quality craftsmanship and timely project completion.
                                    Their renovation approach is tailored to meet individual client preferences,
                                    blending aesthetics with functionality. Swarna’s team of skilled professionals works
                                    closely with clients to revitalize their spaces, enhancing both value and comfort
