                        ...
                        <div class="service-details__left">
                            <div class="service-details__category">
                                <ul class="service-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a
                                            href="<?php echo HTTP_PATH ?>services/constructions/">Construction<span
                                    ...
                                    <li><a href="<?php echo HTTP_PATH ?>services/consultation/">Consultation<span
                                                class="fas fa-angle-right"></span></a></li>
                        ...
                        <div class="service-details__right">
                            <div class="service-details__content-box">
                                <div class="service-details__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/services/constructions.webp"
                                        alt="">
                                </div>
                                <h3 class="service-details__title">Constructions</h3>
                                <p class="service-details__text-1">Swarna Constructions offers expert commercial and
                                    residential building construction services. We specialize in constructing
                                    high-quality commercial buildings, including offices, retail spaces, and warehouses,
                                    tailored to meet business needs. Our residential construction services deliver
                                    personalized homes, ensuring comfort, functionality, and aesthetic appeal. From
                                    concept to completion, we handle every aspect of construction with precision,
                                    providing cost estimates and consultations to bring your vision to life with
                                    exceptional craftsmanship and attention to detail.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
