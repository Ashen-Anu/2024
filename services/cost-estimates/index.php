            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>/</span></li>
                        <li style="color: #ae0001;">Cost Estimates</li>
                    </ul>
                </div>
            </div>
        </section>
                        ...
                        <div class="service-details__left">
                            <div class="service-details__category">
                                <ul class="service-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a href="<?php echo HTTP_PATH ?>services/cost-estimates/">Cost
                                            Estimates<span class="fas fa-angle-right"></span></a></li>
                        ...
                        <div class="service-details__right">
                            <div class="service-details__content-box">
                                <div class="service-details__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/services/cost-estimates.webp"
                                        alt="">
                                </div>
                                <h3 class="service-details__title">Cost Estimates</h3>
                                <p class="service-details__text-1">Swarna Constructions offers precise and transparent
                                    cost estimation services for all construction projects. Through a detailed analysis
                                    of materials, labor, and timelines, they provide accurate forecasts that help
                                    clients manage their budgets efficiently. Their estimates ensure there are no hidden
                                    costs, allowing for smoother project execution. By offering competitive pricing with
                                    a clear breakdown, Swarna helps clients make informed financial decisions from the
                                    project’s inception to its completion.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
