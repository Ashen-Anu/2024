            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/thumbs/1.webp"
                                    alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup"
                                        href="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/1.webp"><span
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/thumbs/2.webp"
                                    alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup"
                                        href="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/2.webp"><span
                                            class="fa fa-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/thumbs/3.webp"
                                    alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup"
                                        href="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/3.webp"><span
                                            class="fa fa-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/thumbs/4.webp"
                                    alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup"
                                        href="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/4.webp"><span
                                            class="fa fa-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/thumbs/5.webp"
                                    alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup"
                                        href="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/5.webp"><span
                                            class="fa fa-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="600ms">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/thumbs/6.webp"
                                    alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup"
                                        href="<?php echo HTTP_PATH ?>assets/images/main/gallery/mr-ajith/6.webp"><span
                                            class="fa fa-plus"></span></a>
                                </div>
                            </div>
                        </div>
