            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li>Projects</li>
                        <li><span>/</span></li>
                        <li style="color: #ae0001;">Construction</li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                        ...
                        <div class="destination-one__single">
                            <div class="destination-one__img-box">
                                <div class="destination-one__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/kusal-cover.webp"
                                        alt="">
                                </div>
                                <div class="destination-one__content">
                                    <h3 class="destination-one__title"><a
                                            href="<?php echo HTTP_PATH ?>projects/construction/house-at-matara/">House
                                            at
                                            Matara</a></h3>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="destination-one__single">
                            <div class="destination-one__img-box">
                                <div class="destination-one__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/wirdana-cover.webp"
                                        alt="">
                                </div>
                                <div class="destination-one__content">
                                    <h3 class="destination-one__title"><a
                                            href="<?php echo HTTP_PATH ?>projects/construction/wirdana-resort/">Wirdana
                                            Resort
                                            & Spa</a></h3>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="destination-one__single">
                            <div class="destination-one__img-box">
                                <div class="destination-one__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/ajith-cover.webp"
                                        alt="">
                                </div>
                                <div class="destination-one__content">
                                    <h3 class="destination-one__title"><a
                                            href="<?php echo HTTP_PATH ?>projects/construction/mr-ajith/">House
                                            At Matara</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="destination-one__single">
                            <div class="destination-one__img-box">
                                <div class="destination-one__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/nirmal-cover.webp"
                                        alt="">
                                </div>
                                <div class="destination-one__content">
                                    <h3 class="destination-one__title"><a
                                            href="<?php echo HTTP_PATH ?>projects/construction/mr-nirmal/">Mr Nirmal's
                                            Residence</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="destination-one__single">
                            <div class="destination-one__img-box">
                                <div class="destination-one__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/turtle-cover.webp"
                                        alt="">
                                </div>
                                <div class="destination-one__content">
                                    <h3 class="destination-one__title"><a
                                            href="<?php echo HTTP_PATH ?>projects/construction/turtle-eco/">Turtle Eco
                                            Beach</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="destination-one__single">
                            <div class="destination-one__img-box">
                                <div class="destination-one__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/apex-cover.webp" alt="">
                                </div>
                                <div class="destination-one__content">
                                    <h3 class="destination-one__title"><a href="#">Apex
                                            Education</a></h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="destination-one__single">
                            <div class="destination-one__img-box">
                                <div class="destination-one__img">
                                    <img src="<?php echo HTTP_PATH ?>assets/images/main/gallery/dressmo-cover.webp"
                                        alt="">
                                </div>
                                <div class="destination-one__content">
                                    <h3 class="destination-one__title"><a href="#">Dressmo</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
